                ...
                <ng-container *ngIf="!removeIconTemplate">
                    <span
                        *ngIf="removeIcon"
                        ...
                        role="button"
                    ></span>
                    <TimesCircleIcon *ngIf="!removeIcon" [class]="'pi-chip-remove-icon'" [attr.data-pc-section]="'removeicon'" [attr.aria-label]="removeAriaLabel" role="button" />
                </ng-container>
                <span *ngIf="removeIconTemplate" [attr.data-pc-section]="'removeicon'" class="pi-chip-remove-icon" [attr.aria-label]="removeAriaLabel" role="button">
